...
public class RNRItems {
    ...
    public static final Item SQUID = register("squid", new Item(new Item.Properties().food(RNRFoodProperties.RAW_SQUID)));
    public static final Item COOKED_SQUID = register("cooked_squid", new Item(new Item.Properties().food(RNRFoodProperties.CALAMARI)));
